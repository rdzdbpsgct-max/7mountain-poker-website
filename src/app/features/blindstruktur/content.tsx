...
const t = {
  de: {
    ...
    smartFeatures: [
      ...
      { title: "Drag & Drop Sortierung", desc: "Verschiebe Blind-Levels per Drag & Drop in die gew\u00fcnschte Reihenfolge. Intuitiv und schnell." },
  ...
  en: {
    ...
    smartFeatures: [
      ...
      { title: "Drag & Drop Reordering", desc: "Rearrange blind levels by drag and drop into your desired order. Intuitive and fast." },
