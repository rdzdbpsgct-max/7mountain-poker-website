...
const t = {
  de: {
    ...
    moreItems: [
      ...
      { label: "Liga-Charts", desc: "3 interaktive SVG-Diagramme: Kumulative Punkte, Platzierungsverlauf und Finanz-Balance \u00fcber alle Spieltage." },
      { label: "Flexible Erstellung", desc: "Liga-Erstellungs-Modal mit Punktesystem-Editor und 3 Presets (Standard, Einfach, Top 10)." },
      ...
      { label: "Export", desc: "JSON-Import/Export, CSV-Download, Text-Export (WhatsApp-freundlich), druckbare Standings." },
    ],
    cta: "Liga erstellen",
  ...
  en: {
    ...
    moreItems: [
      ...
      { label: "League Charts", desc: "3 interactive SVG charts: cumulative points, placement history and financial balance across all game days." },
      { label: "Flexible Creation", desc: "League creation modal with point system editor and 3 presets (Standard, Simple, Top 10)." },
      ...
      { label: "Export", desc: "JSON import/export, CSV download, text export (WhatsApp-friendly), printable standings." },
    ],
    cta: "Create a League",
